/**
 * Globe chapter pins — one unique logo each, spaced so labels don't collide.
 * Names match the official association titles provided by the client.
 */
...
export const globePins = [
  // —— United States cluster (spread across the country) ——
  {
    id: 'toda',
...
// Kept for older imports; globe uses globePins only.
