...
export const globePins = [
  // —— United States (wide fan so logos + labels don’t stack on mobile/web) ——
  {
    id: 'toda',
  ...
  },
  {
    ...
    labelLines: lines('Drivers Association', 'of United States'),
    code: 'US',
    region: 'United States',
    lat: 54.0,
    lng: -100.0,
  ...
  },
  {
    ...
    labelLines: lines('Drivers Association', 'of West'),
    code: 'WEST',
    region: 'United States',
    lat: 48.5,
    lng: -132.0,
  ...
  },
  {
    ...
    labelLines: lines('Drivers Association', 'of Texas'),
    code: 'TX',
    region: 'United States',
    lat: 26.0,
    lng: -101.5,
  ...
  },
  {
    ...
    labelLines: lines('Drivers Association', 'of Midwest'),
    code: 'MW',
    region: 'United States',
    lat: 46.0,
    lng: -86.0,
  ...
  },
  {
    ...
    labelLines: lines('Drivers Association', 'of Northeast'),
    code: 'NE',
    region: 'United States',
    lat: 48.0,
    lng: -62.0,
  ...
  },
  {
    ...
    labelLines: lines('Drivers Association', 'of Southeast'),
    code: 'SE',
    region: 'United States',
    lat: 27.0,
    lng: -74.0,
  ...
  },
  {
    ...
    labelLines: lines('Drivers Association', 'of Southwest'),
    code: 'SW',
    region: 'United States',
    lat: 33.5,
    lng: -118.5,
  ...
  // —— Europe (wide fan into Atlantic / Med / East so mobile labels stay readable) ——
  {
    id: 'europe',
  ...
  // —— Middle East (pulled east/south so they don’t crush into Europe) ——
  {
    id: 'turkey',
